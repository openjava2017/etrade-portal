package com.diligrp.etrade.user.sapi;

import com.diligrp.etrade.user.sapi.domain.CallableComponent;
import com.diligrp.etrade.user.sapi.domain.CallableServiceEndpoint;
import com.diligrp.etrade.user.sapi.domain.ServiceRequest;
 ...
 * @date: 2018/01/08
 */
@Component("callableServiceEngine")
